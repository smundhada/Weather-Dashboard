...
function displayWeather(data, response){
    ...
    var remainIndex = 11 - data.current.uvi;
    var pieColor 
    ...
    var myDoughnutChart = new Chart(ctx1, {
        ...
        datasets: [
            {
                data: [data.current.uvi,remainIndex],
                backgroundColor: [
                    pieColor
                ]
            }]
        ...
        options: {
            ...
            elements: {
                center: {
                    ...
                    font: '10px',
                    fontStyle: "'Montserrat', san-serif", //Default Arial
    ...
    var tempDataTime = [];
    tempDataTime.push(data.daily[0].temp.morn);
    tempDataTime.push(data.daily[0].temp.day);
    tempDataTime.push(data.daily[0].temp.eve);
    tempDataTime.push(data.daily[0].temp.night);
    var tempDatalabel = [];
    tempDatalabel.push("Morning");
    tempDatalabel.push("Day");
    tempDatalabel.push("Evening");
    tempDatalabel.push("Night");
    var ctx5 = document.getElementById("myChart5").getContext('2d');
    var myChart5 = new Chart(ctx5, {
        type: 'line',
        data: {
            labels: tempDatalabel,
            datasets: [{
                label: 'Temperature',
